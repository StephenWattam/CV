...
%S. Piao, F. Dallachy, A. Baron, J. Demmen, S. Wattam, P. Rayson, M. Alexander
%\textsl{``A New Thesaurus-based Semantic Tagger for Deep Semantic Annotation''},
...
% Gues lecture analysing an SSH break-in, including hands-on use of tools.
%
